...
<body class="home">
    ...
    <section class="hero bg-image" data-image-src="images/img/food1.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Koji Food - SuShi Joji</h1>
                <h5 class="font-white space-xs">Đặt món nhanh chóng</h5>
                <div class="steps">
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>Những món ăn nổi bật trong tuần</h2>
                <p class="lead">Sự nổi bật khiến bạn dễ dàng lựa chọn</p>
            </div>
            <div class="row">
                <?php
                ...
                <div class="row how-it-works-solution">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3>Lựa chọn hương vị phù hợp</h3>
                        </div>
                    </div>
                    <div
                    class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <h3>Nhận đồ ăn tại nơi</h3>
                        </div>
                    </div>
                </div>
            </div>
            <!-- 3 block section ends -->
            <div class="row">
                <div class="col-sm-12 text-center">
                    <p class="pay-info">DHHTTT16A - Team TREE</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="featured-restaurants">
        <div class="container">
            ...
            <!-- restuarants listing ends -->
        </div>

    </section>
    <!-- Featured restuarants ends -->
    <!-- start FOOTER -->
    <footer class="footer">
        <div class="container">
            <!-- top footer starts -->
